import { BarChart3, FileText, FolderOpen, Brain, CheckSquare, Sliders, History, Sparkles } from 'lucide-react'
...
export function WorkspaceTabs() {
  ...
  return (
    <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as WorkspaceTab)} className="h-full">
      ...
      <TabsContent value="insights" className="flex-1 min-h-0 animate-fade-in">
        <Insights />
      </TabsContent>
      ...
      <TabsContent value="runs" className="flex-1 min-h-0 animate-fade-in">
        <RunHistory />
      </TabsContent>
    </Tabs>
  )
