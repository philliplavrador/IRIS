...
from casi.engine.helpers import cross_correlate_pair
from casi.engine.types import CATrace, PipelineContext, SpikePCA, SpikeTrain
...
def op_spike_curate(left: SpikePCA, right: CATrace, ctx: PipelineContext, *,
    ...
    from casi.engine.ops.simulation import _build_gcamp_kernel
