"""
Data type dataclasses for the CASI pipeline engine.
...
class CorrelationResult:
    ...
    fs_hz: float
    label: str = ""
    pct_masked: Optional[np.ndarray] = None
...
class FreqPowerTraces:
    ...
    times: np.ndarray
    freq_traces: Dict[float, np.ndarray]
    broadband_power: np.ndarray
