...
async def add_history(req: HistoryAddRequest):
    ...
    from casi.projects import append_history, resolve_active_project

    if req.project:
        project_path = get_casi_root() / "projects" / req.project
...
async def find_plot(dsl: str, window: str = "full"):
    ...
    from casi.projects import find_cached_plots, resolve_active_project
