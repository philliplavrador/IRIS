...
from iris.engine.loaders import load_ca_trace, load_mea_trace, load_rtsort
from iris.engine.margins import margin_butter_bandpass, margin_notch_filter
from iris.engine.ops.analysis import op_baseline_correction, op_spike_curate, op_spike_pca
from iris.engine.ops.correlation import op_x_corr
from iris.engine.ops.detection import (
    op_constant_rms, op_rt_detect, op_rt_thresh, op_sigmoid, op_sliding_rms,
)
from iris.engine.ops.filtering import op_amp_gain_correction, op_butter_bandpass, op_notch_filter
from iris.engine.ops.saturation import op_saturation_mask, op_saturation_survey
from iris.engine.ops.simulation import op_gcamp_sim
from iris.engine.ops.spectral import op_freq_traces, op_spectrogram
...
def create_registry(
    ...
    # Plot handlers (live in iris.plot_backends/, dispatched by chosen backend)
    from iris.plot_backends import register_for_backend
