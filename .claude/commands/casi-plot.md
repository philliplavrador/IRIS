---
description: Generate a CASI plot from a natural-language request
allowed-tools: Task
argument-hint: [what you want to plot]
---

Use the `casi` subagent to translate the following request into a DSL string and run it via the `casi` CLI:
