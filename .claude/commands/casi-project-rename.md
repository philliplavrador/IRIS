---
description: Rename an existing CASI project
allowed-tools: Bash, Read, Edit
argument-hint: <old-name> <new-name>
---

Rename a CASI project workspace.
...
3. Check whether `<old-name>` is the active project by reading `.casi/active_project`.
...
6. If the project was active, run `casi project open <new-name>` to update the pointer.
